...
class CIFAR10DLGetter: # use this to create data loaders
    ...
    def get_valloader(self):
        ...
        val_loader = DataLoader(val_subset, batch_size=self.batch_size, num_workers=4, pin_memory=True, shuffle=False)
        return val_loader

    def get_testloader(self):
        test_loader = DataLoader(self.test_dataset, batch_size=self.batch_size,num_workers=4, pin_memory=True, shuffle=False)
        return test_loader
